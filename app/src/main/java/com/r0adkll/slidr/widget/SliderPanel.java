...
public class SliderPanel extends FrameLayout {
    ...
    private void init(){
        ...
        this.mProxyView = new CanvasProxyView(getContext());
        addView(this.mProxyView);
        this.mDimView = new View(getContext());
        this.mDimView.setBackgroundColor(this.config.getScrimColor());
        this.mDimView.setAlpha(this.config.getScrimStartAlpha());
    ...
    private void applyScrim(float f){
        this.mDimView.setAlpha((f * (this.config.getScrimStartAlpha() - this.config.getScrimEndAlpha())) + this.config.getScrimEndAlpha());
    }
